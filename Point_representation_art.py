...
class MyCanvas(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.drawPoint(168, 320) , painter.drawPoint(170, 320) , painter.drawPoint(170, 320)
        
        painter.drawPoint(156, 310) , painter.drawPoint(160, 310) , painter.drawPoint(160, 310)
        painter.drawPoint(344, 310)
        ...
        painter.drawPoint(344, 310) , painter.drawPoint(340, 310) , painter.drawPoint(340, 310)
        ...
        painter.drawPoint(337, 300)
        #art 폴더
        painter.drawPoint(175, 310)
        painter.drawPoint(331, 310)
        
        painter.drawPoint(187, 320)
        painter.drawPoint(321, 320)
        
        painter.drawPoint(195, 330)
        painter.drawPoint(311, 330)
        
        painter.drawPoint(205, 340)
        painter.drawPoint(305, 340)
        
        painter.drawPoint(215, 350)
        
        painter.drawPoint(225, 360)
        
        painter.drawPoint(235, 370)
        
        painter.drawPoint(245, 380)
        ##########################################################################
        ...
        #######################################210
        flowerpink = QPen(QColor(255, 178, 245), 10, Qt.SolidLine)    
        painter.setPen(yellow)
        painter.drawPoint(240, 210)
        painter.drawPoint(230, 205)
        painter.drawPoint(220, 200)
        painter.drawPoint(210, 195)
        painter.drawPoint(200, 189)
        painter.drawPoint(192, 185)
        painter.drawPoint(187, 183)
        painter.drawPoint(182, 183)
        painter.drawPoint(172, 184)
        painter.drawPoint(162, 187)
        painter.drawPoint(154, 190)
        painter.drawPoint(149, 195)
        painter.drawPoint(144, 205)
        painter.drawPoint(142, 215)
        painter.drawPoint(140, 225)
        painter.drawPoint(140, 235)
        painter.drawPoint(141, 245)
        painter.drawPoint(143, 255)
        painter.drawPoint(146, 265)
        painter.drawPoint(150, 275)
        painter.drawPoint(155, 280)
        painter.drawPoint(162, 290)
        painter.drawPoint(169, 300)
        painter.drawPoint(180, 310)
        painter.drawPoint(195, 320)
        painter.drawPoint(215, 320)
        painter.drawPoint(235, 320)
        painter.drawPoint(255, 320)
        painter.drawPoint(275, 320)
        painter.drawPoint(295, 320)
        painter.drawPoint(313, 320)
        painter.drawPoint(322, 310)
        painter.drawPoint(328, 300)
        painter.drawPoint(338, 290)
        painter.drawPoint(343, 280)
        painter.drawPoint(351, 270)
        painter.drawPoint(355, 260)
        painter.drawPoint(358, 250)
        painter.drawPoint(359, 240)
        painter.drawPoint(358, 230)
        painter.drawPoint(357, 220)
        painter.drawPoint(355, 210)
        painter.drawPoint(351, 204)
        painter.drawPoint(347, 197)
        painter.drawPoint(343, 193)
        painter.drawPoint(337, 188)
        painter.drawPoint(332, 185)
        painter.drawPoint(327, 182)
        painter.drawPoint(320, 181)
        painter.drawPoint(310, 181)
        painter.drawPoint(305, 185)
        painter.drawPoint(300, 186)
        painter.drawPoint(295, 189)
        painter.drawPoint(285, 194)
        painter.drawPoint(275, 200)
        painter.drawPoint(270, 205)
        painter.drawPoint(260, 210)
        ########################################
        painter.setPen(flowerpink)
        painter.drawPoint(270, 210)
        painter.drawPoint(230, 210)
        painter.drawPoint(220, 220)
        painter.drawPoint(260, 220)
        painter.drawPoint(240, 220)
        painter.drawPoint(280, 220)
        ############################################
        painter.drawPoint(210, 230)
        painter.drawPoint(230, 230)
        painter.drawPoint(250, 230)
        painter.drawPoint(270, 230)
        painter.drawPoint(290, 230)
        ###############################
        painter.drawPoint(220, 240)
        painter.drawPoint(240, 240)
        painter.drawPoint(260, 240)
        painter.drawPoint(280, 240)
        ####################################
        painter.drawPoint(210, 250)
        painter.drawPoint(230, 250)
        painter.drawPoint(250, 250)
        painter.drawPoint(270, 250)
        painter.drawPoint(290, 250)
        ##################################
        painter.drawPoint(220, 260)
        painter.drawPoint(240, 260)
        painter.drawPoint(260, 260)
        painter.drawPoint(280, 260)
        painter.drawPoint(300, 260)
        ############################
        painter.drawPoint(210, 270)
        painter.drawPoint(230, 270)
        painter.drawPoint(250, 270)
        painter.drawPoint(270, 270)
        painter.drawPoint(290, 270)
        ##################################
        painter.drawPoint(220, 280)
        painter.drawPoint(240, 280)
        painter.drawPoint(260, 280)
        painter.drawPoint(280, 280)
        painter.drawPoint(300, 280)
        ##################################
